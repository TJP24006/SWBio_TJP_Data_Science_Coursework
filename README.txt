...
Dataset included under /data folder. Example dataset should be named LESAPeakArea.csv and contain 766 samples, under 7 column headings. As part of the code a second cleaned dataset with be outputted named cleaned_LESAPeakdata.csv. Please ensure data folder containing LESAPeakArea.csv is in your working directory, or the code will not run.
